...
class_name FilterOptionsWithoutSuitCardAction
...
func _validate_property(property: Dictionary):
	if property.name == "suits" and suits_parameter_type != Const.ActionParameterType.VALUE:
		property.usage = PROPERTY_USAGE_NO_EDITOR
	elif property.name == "suits_key" and suits_parameter_type != Const.ActionParameterType.KEY:
		property.usage = PROPERTY_USAGE_NO_EDITOR
