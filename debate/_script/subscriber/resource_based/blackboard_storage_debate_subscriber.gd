...
func on_turn_start(contestant: Contestant):
	...
	blackboard.add_flag(Flag.TURN_CARD_HISTORY, [], Blackboard.ExpirationToken.ON_DEBATE_START)
	blackboard.add_flag(Flag.TURN_TOKEN_HISTORY, [], Blackboard.ExpirationToken.ON_DEBATE_START)
...
func on_card_played(card: Card, _contestant : Contestant):
	...
	blackboard.add_flag(Flag.TURN_CARD_HISTORY, turn_history, Blackboard.ExpirationToken.ON_DEBATE_START)
...
func on_token_played(token: Token, _suit: Suit, _contestant : Contestant):
	...
	blackboard.add_flag(Flag.TURN_TOKEN_HISTORY, turn_history, Blackboard.ExpirationToken.ON_DEBATE_START)

func on_lines_cleared(count : int):
	blackboard.add_key(Flag.LINES_CLEARED, manager.lines_cleared, Blackboard.ExpirationToken.ON_DEBATE_START)
